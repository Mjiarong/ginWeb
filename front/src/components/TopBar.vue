					...
					<v-card>
						...
						<v-form ref="loginFormRef" v-model="valid">
							<v-card-text class="mt-5">
								<v-text-field v-model="formdata.username" hint="至少4个字符" counter="12" :rules="nameRules"
									label="请输入用户名"></v-text-field>
								<v-text-field v-model="formdata.password" hint="至少6个字符" counter="20"
									:rules="passwordRules" label="请输入密码" type="password"></v-text-field>
							</v-card-text>
